...
def process():
    ...
    sheet_vendedores = "Detalle por Producto"
    if sheet_vendedores not in inFile.get_sheet_names():
        ...
        for v in sorted(vendedores.keys()):
            ...
            for p in vendedores[v].products:
                ...
                vend_sheet.cell(row=row_idx, column=2).value = vendedores[v].prices[p]/1.05 * vendedores[v].vendidos[p]
